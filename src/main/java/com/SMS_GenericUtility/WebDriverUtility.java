...
public void selectbyvisibal(WebElement element,String value)
{
...
public void doubleClickAction(WebDriver driver)
{
 ...
 public void implictlyWait(WebDriver driver,int second)
 {
 ...
 public static String getScreenShot(WebDriver driver,String screenShotName) throws Throwable
 {
	...
	String dt = new JavaUtility().getSystemDate();
	String path = " ./screenshot"+screenShotName+dt+".png"; 
